...
m_clientSocket(socket), m_socketBuffer(new QByteArray()), m_previousSize(0)
{
    ...
    m_clientSocket->setSocketOption(QAbstractSocket::ReceiveBufferSizeSocketOption, 2 * 1024 * 1024);
    m_clientSocket->setSocketOption(QAbstractSocket::SendBufferSizeSocketOption, 2 * 1024 * 1024);*/
