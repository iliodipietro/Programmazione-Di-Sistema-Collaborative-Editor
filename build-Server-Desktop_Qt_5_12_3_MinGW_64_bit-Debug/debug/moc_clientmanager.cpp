...
QT_MOC_LITERAL(3, 31, 14), // "ClientManager*"
QT_MOC_LITERAL(4, 46, 12), // "disconnected"
QT_MOC_LITERAL(5, 59, 9), // "readyRead"
QT_MOC_LITERAL(6, 69, 12) // "onDisconnect"

    },
    "ClientManager\0messageReceived\0\0"
    "ClientManager*\0disconnected\0readyRead\0"
    "onDisconnect"
};
...
void ClientManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->messageReceived((*reinterpret_cast< ClientManager*(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ClientManager::*)(ClientManager * , QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientManager::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientManager::messageReceived(ClientManager * _t1, QByteArray _t2)
{
